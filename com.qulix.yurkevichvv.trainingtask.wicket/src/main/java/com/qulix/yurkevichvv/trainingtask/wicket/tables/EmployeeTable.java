...
public class EmployeeTable extends ListView<Employee> {

    public EmployeeTable(String id, List<Employee> employees) {
        super(id, employees);
    }

    @Override
    public void populateItem(ListItem<Employee> item) {
