...
INSERT INTO "PUBLIC"."PROJECT" ( "ID", "TITLE", "DESCRIPTION" )
VALUES ( 1, 'MobilBank', 'Мобильное банковское приложение');
INSERT INTO "PUBLIC"."PROJECT" ( "ID", "TITLE", "DESCRIPTION" ) VALUES ( 2, 'Microsoft', 'Операционная система');
INSERT INTO "PUBLIC"."PROJECT" ( "ID", "TITLE", "DESCRIPTION" ) VALUES ( 3, 'Witcher 4', 'Компьютерная игра');
INSERT INTO "PUBLIC"."PROJECT" ( "ID", "TITLE", "DESCRIPTION" ) VALUES ( 4, 'PowerPoint', 'Программа для презентаций');
